...
Then, write a function named speaker that takes in a string and a callback function. The speaker function 
should return the string in all uppercase letters only by invoking the callback.
------------------------------------------------------------------------------------------------ */
...
const fizzbuzz = (arr) => {
  ...
  arr.forEach(function(value){
    ...
    if (value/3 == (Math.floor(value/3)) && value/5 == (Math.floor(value/5))){
      result.push("Fizz Buzz");
    }else if (value/3 == (Math.floor(value/3)) ){
      result.push("Fizz");
    }else if (value/5 == (Math.floor(value/5)) ){
      result.push("Buzz");
    } else {
      result.push(value)
    };
