...
Write a function named templatingWithMustache that uses mustache to create the markup
templates for each of the characters. Use the snippet as your guide for creating your templates.
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(value=>{
    ...
    let result = Object.values(value.children);
    fr = Boolean(result.join());
    }
  })
